...
export const createMerchantCustomAttributeDefinitionRequestSchema: Schema<CreateMerchantCustomAttributeDefinitionRequest> =
  s.object<CreateMerchantCustomAttributeDefinitionRequest>({
