...
export type ListMerchantCustomAttributeDefinitionsResponse = {
  customAttributeDefinitions?: CustomAttributeDefinition[];
  cursor?: string;
  errors?: Error[];
};

export const listMerchantCustomAttributeDefinitionsResponseSchema: Schema<ListMerchantCustomAttributeDefinitionsResponse> =
  s.object<ListMerchantCustomAttributeDefinitionsResponse>({
