...
export const updateBookingCustomAttributeDefinitionResponseSchema: Schema<UpdateBookingCustomAttributeDefinitionResponse> =
  s.object<UpdateBookingCustomAttributeDefinitionResponse>({
